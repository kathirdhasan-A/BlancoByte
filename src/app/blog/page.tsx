...
import { getPaginatedPosts, getAllTags, getTotalPages } from "@/lib/blog";
...
export const metadata: Metadata = {
  ...
  description: "Articles and notes on databases, analytics, performance, and running data privately, from the BlancoByte team.",
  alternates: { canonical: "https://blancobyte.com/blog" },
};
      ...
      <div className="section-container">
        ...
        <div className="mx-auto mt-8 max-w-5xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <SiteSearch />
            <a href="/feed.xml" className="flex items-center gap-1.5 text-sm text-text-muted transition hover:text-accent" title="RSS Feed"><Icon name="rss-line" size={16} /></a>
          </div>
        </div>
